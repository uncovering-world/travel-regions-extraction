...
- `may_merge` produced: no

## Representative classification comparison

- C001/P1: contract representative `separation_not_proven`; evaluator `data_unknown`.
- C032/P1: contract representative `data_unknown`; evaluator `separation_not_proven`.
- C040/P1: contract representative `data_unknown`; evaluator `separation_not_proven`.
